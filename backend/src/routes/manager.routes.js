...
import { loginManager, registerEmployee, registerManager, get_all_stocks, get_low_stocks, get_all_availble_stocks_warehouse, place_request , get_all_stocks_pend_request, get_all_stocks_pend_out_request, add_check_list, reject_order, get_all_profile_detail} from '../controllers/manager.controllers.js';
